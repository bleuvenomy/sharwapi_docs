...
v0.2.0 contains **breaking changes**. Plugins may not work correctly after a simple binary replacement. Please read the [Migration Guide](/en/migration/v0.1.0-to-v0.2.0/user) before upgrading.
:::
...
This affects the logging configuration section in `appsettings.json`. See the [User Migration Guide](/en/migration/v0.1.0-to-v0.2.0/user) for details.
...
See the [Developer Migration Guide](/en/migration/v0.1.0-to-v0.2.0/developer) for details.
