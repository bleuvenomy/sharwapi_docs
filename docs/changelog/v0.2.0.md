...
::: warning 升级注意
v0.2.0 包含**破坏性变更**，直接替换二进制文件后插件可能无法正常运行。请在升级前阅读 [迁移指南](/migration/v0.1.0-to-v0.2.0/user)。
:::
...
受此影响，`appsettings.json` 中的日志配置节发生了变更。详见 [用户侧迁移指南](/migration/v0.1.0-to-v0.2.0/user)。
...
详见 [开发者侧迁移指南](/migration/v0.1.0-to-v0.2.0/developer)。
