# 从 v0.1.0 升级到 v0.2.x — 开发者侧

本页面面向**开发 SharwAPI 插件**的开发者，介绍从 v0.1.0 升级到 v0.2.x 时需要关注的接口变更和迁移操作。
...
> ✅ 基于 v0.1.0 编译的插件 DLL **无需重新编译**即可在 v0.2.x 主程序上运行。

但为了充分利用 v0.2.x 的新特性，建议按本指南对插件进行更新。
